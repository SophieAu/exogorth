...
/**
 * Hier werden alle Objekte (momentan nur Hintergrund, Spieler, Bullet) gemalt
 * 
 * @author Sophie
 *
 */
...
public class Draws extends JFrame {
	...
	private void draw(Graphics g) {
		g.drawImage(bg.getPlayerImage(), bg.getXCoord(), 0, null);
		g.drawImage(bg.getPlayerImage(), bg.getXCoord() + bg.getPlayerImage().getWidth(), 0, null);
